...
describe('Notification Controller Tests', function () {
    it('returns all notifications for the authenticated customer', function () {
        ...
        $res = $this->getJson(route('customer.notification.all'))->assertOk();
    ...
    it('return true when there are new notifications', function () {
        ...
        $res = $this->getJson(route('customer.notification.checkNew'))->assertOk();
    ...
    it('finds a specific notification by ID', function () {
        ...
        $res = $this->getJson(route('customer.notification.find', ['notification_id' => $notification->id]))
            ->assertOk();
    ...
    it('fails to find an notification with invalid ID', function () {
        $this->getJson(
            route('customer.notification.find', ['notification_id' => 422])
        )->assertStatus(422);
    });
    ...
    it('set notification as viewed', function () {
        ...
        $this->postJson(
            route('customer.notification.view'),
    ...
    it('delete notification', function () {
        $notification = Notification::factory()->for($this->user, 'holder')->create();
        $this->deleteJson(
            route('customer.notification.delete'),
    ...
    it('clear all notification', function () {
        ...
        $this->postJson(route('customer.notification.clear'))->assertOk();
